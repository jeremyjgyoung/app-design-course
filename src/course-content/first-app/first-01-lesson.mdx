...
If you want to continue on with the same exercise or code base later press the Save button and copy the URL to refer to later. 
...
Let's add two properties, a *borderWidth* of *"10px"* and a *borderColor* of *"#000000"*.
