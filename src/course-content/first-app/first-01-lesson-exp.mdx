...
This section will explain the concepts from the last activity set. 
You are not modifying code in this section.

## Keywords, Variables, and Properties

In any language there is a group of keywords.
In our first activity set the JavaScript keywords included *import*, *let*, *return*, and *export*. 
Each of these words have a special meaning.
...
After the import statements, we defined our App component. 
We determine what the app will look like within the return statement of the App component.
...
We export our App at the bottom to make this code available outside of the file.
